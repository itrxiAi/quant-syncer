...
exports.SyncModule = SyncModule = __decorate([
    (0, common_1.Module)({
        imports: [schedule_1.ScheduleModule.forRoot(), admin_module_1.AdminModule, adapters_module_1.AdaptersModule, bars_module_1.BarsModule, prisma_module_1.PrismaModule],
